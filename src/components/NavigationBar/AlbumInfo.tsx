...
export const AlbumInfo = () => {
  ...
  if (chosenAlbum) {
    children = (
      <div id="album-info" className="xs:hidden md:flex gap-8 items-center justify-center h-full text-black text-sm leading-8 md:w-full">
  ...
  return (
    <div className={`h-[4em] ${!!chosenAlbum && 'xs:h-[1em] sm:h-[4em] md:h-[4em] lg:h-[4em] xl:h-[4em]'} px-4 bg-white`}>
